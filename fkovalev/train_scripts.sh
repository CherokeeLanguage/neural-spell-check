...
cat train.src.txt | sed 's/ /■/g' | sed 's/\(.\)/\1 /g' > train.src.tok
...
CUDA_VISIBLE_DEVICES=3 th translate.lua -model /var/data/fkovalev/char_correction_epoch4_1.03.t7 -src /var/data/fkovalev/test_data.tok -output /var/data/fkovalev/test_corrections.tok -gpuid 1